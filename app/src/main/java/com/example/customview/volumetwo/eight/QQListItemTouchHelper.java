 ...
 * {@link QQListItemTouchHelper.Callback} class or implementing {@link QQListItemTouchHelper.ViewDropHandler}
 ...
 */
public class QQListItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    @VisibleForTesting
    List<QQListItemTouchHelper.RecoverAnimation> mRecoverAnimations = new ArrayList<>();
     ...
     */
    public QQListItemTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
     ...
     *
     * @param选择 The ViewHolder 进行拖动或滑动。如果要取消
     * 当前操作，但如果 actionState 为 ACTION_STATE_DRAG，则可能不是 null。
     * @param actionState 动作类型
     */
    @SuppressWarnings("WeakerAccess")
     ...
     * {@link QQListItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p>
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{@link QQListItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     *                   RecyclerView.
     * @see QQListItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
     ...
     * behavior
     * by overriding {@link QQListItemTouchHelper.Callback}
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper is attached.</li>
     * <li>{@link QQListItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
     ...
     * {@link QQListItemTouchHelper}.
     */
    public interface ViewDropHandler {

        /**
         * Called by the {@link QQListItemTouchHelper} after a View is dropped over another View.
         * <p>
    ...
    public abstract static class Callback {
        ...
        public static ItemTouchUIUtil getDefaultUIUtil() {
            return QQListItemTouchUIUtilImpl.INSTANCE;
        }
         ...
         *                    it is cleared.
         * @param actionState One of {@link QQListItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link QQListItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link QQListItemTouchHelper#ACTION_STATE_DRAG}.
         * @see #clearView(RecyclerView, RecyclerView.ViewHolder)
         */
        public void onSelectedChanged(@Nullable ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                QQListItemTouchUIUtilImpl.INSTANCE.onSelected(viewHolder.itemView);
            }
        }
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                    List<QQListItemTouchHelper.RecoverAnimation> recoverAnimationList,
                    int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final QQListItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
        ...
        public void clearView(@NonNull RecyclerView recyclerView, @NonNull ViewHolder viewHolder) {
            QQListItemTouchUIUtilImpl.INSTANCE.clearView(viewHolder.itemView);
        }
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
            ...
            QQListItemTouchUIUtilImpl.INSTANCE.onDraw(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
        ...
        public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
                                    ...
                                    ViewHolder viewHolder,
                                    float dX, float dY, int actionState, boolean isCurrentlyActive) {
            QQListItemTouchUIUtilImpl.INSTANCE.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY,
                    actionState, isCurrentlyActive);
        }
