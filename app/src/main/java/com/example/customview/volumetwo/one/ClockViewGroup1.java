...
public class ClockViewGroup1 extends LinearLayout {
    ...
    public ClockViewGroup1(Context context) {
        super(context);
    }

    public ClockViewGroup1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ClockViewGroup1(Context context, AttributeSet attrs, int defStyleAttr) {
